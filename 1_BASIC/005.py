...
def draw_cell_by_cr(canvas, c, r, color=canvasColor):
    """
    ...
    canvas.create_rectangle(x0, y0, x1, y1, fill=color, outline=outlineColor, width=outlineWidth)
...
def draw_cells(canvas, c, r, cell_list, color=canvasColor):
    """
    绘制指定形状指定颜色的俄罗斯方块
    :param canvas: 画板
